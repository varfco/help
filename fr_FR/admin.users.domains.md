If present, this page shows you a list of domains that are blocked. Registrations from email addresses with these domain names will not be accepted. A button next to the domain allows you to unblock it.
